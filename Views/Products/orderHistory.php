                    ...
                    <?php foreach ($orders as $order): ?>
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="p-3 flex space-x-2">
                                <a href="/orderHistory/view?id=<?php echo urlencode($order['id']); ?>" class="text-blue-500 hover:underline">View</a>
                                <a href="/orderHistory/delete?id=<?php echo urlencode($order['id']); ?>" onclick="return confirm('Are you sure?');" class="text-red-500 hover:underline">Delete</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
