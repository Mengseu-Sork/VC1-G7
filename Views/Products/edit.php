...
<body>
    <div class="container">
        <h4>Edit Product</h4>
        <form id="addProductForm" action="/products/update/<?php echo $product['id']; ?>" method="POST" enctype="multipart/form-data">
            <div class="grid">
                ...
                <div class="flex-col md-col-span-1">
                    ...
                    <select name="category_id" id="category_id" required>
                        ...
                        <option value="1" <?php if ($product['category_id'] == 1) echo 'selected'; ?>>Nut Products</option>
                        <option value="2" <?php if ($product['category_id'] == 2) echo 'selected'; ?>>Powder Products</option>
                        <option value="3" <?php if ($product['category_id'] == 3) echo 'selected'; ?>>Drinks Products</option>
                    </select>
