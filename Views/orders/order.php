...
<body class="bg-white text-gray-800 max-w-xl mx-auto p-6">
    ...
    <form id="order-form">
        ...
        <!-- Pickup Details -->
        <div class="mb-8">
            <p class="text-sm text-gray-500 mb-4">Loading smart payment buttons...</p>
        ...
        <div class="mt-6 flex justify-end gap-4">
            <button type="button" id="cancelBtn"
                class="w-28 bg-yellow-500 hover:bg-yellow-500 text-white font-semibold py-2 rounded shadow">
                Cancel
            </button>
            <button type="submit"
                class="w-28 bg-green-600 hover:bg-green-600 text-white font-semibold py-2 rounded shadow">
                Submit
            </button>
        </div>
    </form>
