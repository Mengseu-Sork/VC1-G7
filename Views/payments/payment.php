                ...
                <div class="bg-white rounded-lg shadow-lg p-6 mb-5">
                    <div class="flex flex-wrap justify-between items-center gap-5">
                        ...
                        <div class="flex gap-4 overflow-x-auto">
                            <div class="flex-1 bg-blue-600 text-white rounded-lg p-5 relative">
                                ...
                                <div class="absolute right-[-8px] top-1/2 transform -translate-y-1/2 w-4 h-4 bg-white text-gray-600 text-xs flex items-center justify-center rounded-full">›</div>
                            </div>
                            
                            <div class="flex-1 bg-gray-800 text-white rounded-lg p-5 relative">
                                <div class="flex items-center gap-2 text-sm mb-6">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            ...
                            <div class="flex-1 bg-green-600 text-white rounded-lg p-5 relative">
                                <div class="flex items-center gap-2 text-sm mb-6">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                ...
                                <tr class="border-t border-gray-300">
                                    ...
                                    <td class="px-4 py-4">
                                        <div class="flex items-center gap-2">
                                            <img src="/placeholder.svg?height=32&width=32" alt="Mattie Stone" class="w-8 h-8 rounded-full object-cover">
