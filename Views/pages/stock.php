         ...
         <?php if (!empty($stocks)) : ?>
             <?php foreach ($stocks as $stock) : ?>
                <div class="bg-white rounded-lg shadow-lg p-4 text-center">
                    <h2 class="text-lg font-semibold"><?php echo htmlspecialchars($stock['product_name']); ?></h2>
                    <p class="text-md font-bold mt-1">Quantity: <?php echo htmlspecialchars($stock['quantity']); ?></p>
