        ...
        <div x-data="{ bgColor: 'white' }" class="rounded-lg p-6">
            <div class="shadow-lg rounded-lg p-6 border-2 border-gray-200 dark:border-primary-darker transition duration-300"
                ...
                <div class="flex flex-wrap gap-8 p-4 justify-between">
                    ...
                    <select class="pr-5 pl-2 border border-gray-300 rounded-md transition duration-300 mr-1 bg-white dark:bg-darker border-b dark:border-primary-darker" onchange="location = this.value;">
                ...
                <div class="container flex flex-wrap gap-8 p-4 justify-center" id="productContainer">
                    ...
                    foreach ($products as $product) {  
                        echo '<div class="w-48 h-80 bg-white border border-gray-300 p-2 rounded-lg shadow-md transition duration-300 flex flex-col items-center bg-white dark:bg-darker border-b dark:border-primary-darker">';
