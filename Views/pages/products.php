            ...
            <div class="shadow-lg rounded-lg p-6 border-2 border-gray-200 dark:border-primary-darker transition duration-300"  
                ...
                <div class="container flex flex-wrap gap-8 p-4 justify-center" id="productContainer">  
                    <?php foreach ($products as $product): ?>  
                        <div class="w-48 h-72 bg-white border border-gray-300 p-4 rounded-lg shadow-md transition duration-300 flex flex-col items-center"  
                            ...
                            <p class="text-gl text-green-600 font-semibold">  
                                <span class="ml-4 bg-green-200 text-green-800 text-xs font-bold px-3 py-1 rounded-full">In Stock</span>  
                            </p>  
