            ...
            <div class="shadow-lg rounded-lg p-6 border-2 border-gray-200 dark:border-primary-darker transition duration-300"
                ...
                <div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                                <?php foreach ($items as $product): ?>
                                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4 transition hover:scale-105 hover:shadow-lg">
                                        <div class="image">
                                            <a href="./viewProduct.php"><img  src="<?= $product['image']; ?>" alt="<?= $product['name']; ?>"class="w-full h-40 object-cover rounded-lg mb-4"></a>
                    ...
                    <div style="text-align: right;">
                        <a href="/pages/addProduct"><button type="submit" class="inline-block rounded bg-blue-500 text-white px-4 py-2 font-medium uppercase shadow">Add more</button></a>
                    </div>
                </div>
            </div>
        </div>
