                        ...
                        <div class="flex-1">
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <div class="w-80 border border-gray-300 p-2 rounded-md focus:ring-2 dark:border-primary-darker focus:ring-blue-500"><?= $user['FirstName']?></div>
                                        
                                </div>
                                <div>
                                    <label class="block font-semibold mb-3">Last Name</label>
                                    <div class="w-88 border border-gray-300 p-2 rounded-md focus:ring-2 dark:border-primary-darker focus:ring-blue-500"><?= $user['LastName']?></div>
