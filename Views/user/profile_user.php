...
<div class="container mx-auto p-6">
            ...
            <div class="shadow-lg rounded-lg p-6 transition duration-300 border-2 dark:border-primary-darker" :style="{ backgroundColor: bgColor }">
                <?php if (!empty($users)): ?>
                    ...
                    <div class="text-center mt-4">
                        <h1 class="text-5xl font-bold"><?= htmlspecialchars($user['FisrtName']). "  " .htmlspecialchars($user['LastName']) ?></h1>
                        <br>
                        <p class="text-3xl font-semibold"><?= htmlspecialchars($user['email']) ?></p>
                    </div>
                    <?php endforeach; ?>
                <?php else: ?>
    ...
    <div class="md:col-span-2">
        ...
        <a href="../user/edit.php" class="bg-green-500 text-white px-6 py-2 rounded-lg hover:bg-blue-400 text-center w-20 ml-6">Edit Profile</a>
    </div>
</div>
